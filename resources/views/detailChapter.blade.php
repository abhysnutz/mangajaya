                ...
                <div class="perapih">
                    <div class="dsk2 sd" id="Deskripsi">
                        ...
                        <div class="new new2" style="margin-bottom:0">
                            @if($detail_manga->id_chapter > $idMinChapterManga)
                            ...
                            @endif
                            @if($detail_manga->id_chapter < $idMaxChapterManga)
                ...
                <div class="nva" style="background: #000;">
                    <ul class="perapih">
                        <li>
                            ...
                            </svg> Chapter {{str_replace('.0', '', $detail_manga->episode_chapter)}} dari {{str_replace('.0', '', $maxChapterManga->episode_chapter)}}</li>
